...
- [Patient Journey Flow](#patient-journey-flow)
- [Architecture](#architecture)
  - [Core Agent Architecture](#core-agent-architecture)
  - [Advanced Agentic Architecture](#advanced-agentic-architecture)
  - [Enterprise Architecture](#enterprise--hackathon-level-architecture)
...
### 👁️ Poor Visibility of Availability
